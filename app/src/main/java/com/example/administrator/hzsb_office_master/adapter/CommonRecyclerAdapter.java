...
import com.example.hzsb_office_interface.adapter.BaseAdapterHelper;
import com.example.hzsb_office_interface.adapter.IAdapter;
import com.example.hzsb_office_interface.adapter.IData;
...
public abstract class CommonRecyclerAdapter<T> extends RecyclerView.Adapter implements IAdapter<T>,IData<T> {
    ...
    @Override public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final BaseAdapterHelper helper = BaseAdapterHelper.get(mContext, null, parent, viewType);
